...
using CadmusGeoApi.Services;

namespace CadmusGeoApi;
...
public static class Program
{
        ...
        IConfiguration config)
    {
        ...
        services.AddSingleton<IRepositoryProvider>(
            _ => new GeoRepositoryProvider { ConnectionString = dataCS });

        // part seeder factory provider
        services.AddSingleton<IPartSeederFactoryProvider,
            GeoPartSeederFactoryProvider>();
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            {
                options.WithTitle("Cadmus Geography API")
